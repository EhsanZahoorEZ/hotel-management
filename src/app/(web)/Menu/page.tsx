...
//         setSuccessMessage(`Successfully ordered ${item.name}`);
//         setTimeout(() => {
...
//                                 className="bg-orange-400 text-white hover:scale-110 duration-400 border-4 border-gray-300 transition-all shadow-primary text-lg font-serif font-extrabold rounded-xl flex justify-center items-center py-2 px-4 md:px-6 lg:px-8">
//                                 Order Now
//                             </button>
//                         </div>
//                     </div>
